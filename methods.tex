...
\todo{maybe add distribution plots}
\todo{a plot with a better explanation of what reaction and movement time means}
...
\todo{give number of average amount of trials or a plot of n\_trials distribution?}
...
\end{figure}
\todo{move d) and e) of the figure into a separate figure in the interesting spaces section}
...
\todo{can I assume this properties of pca as background of the reader?}
...
\todo{add that dot product was only used for grouping, matching score by corrcoef}
...
\begin{figure}[ht]
	...
	\label{sg:fig:images_cstd_pd}
\end{figure}
\todo{is there any result now, where I measure the directedness of muscle synergies?}
\todo{move d) and e) of the figure into a separate figure in the interesting spaces section}
